...
import { useSSRContext, withAsyncContext, unref, withCtx, createVNode, defineComponent, ref, computed, watch, mergeProps } from 'file:///Users/arnaudmichel/Documents/GC-Tech/vuejs-travel-card-component/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass } from 'file:///Users/arnaudmichel/Documents/GC-Tech/vuejs-travel-card-component/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { Swiper, SwiperSlide } from 'file:///Users/arnaudmichel/Documents/GC-Tech/vuejs-travel-card-component/node_modules/swiper/swiper-vue.mjs';
import { Autoplay } from 'file:///Users/arnaudmichel/Documents/GC-Tech/vuejs-travel-card-component/node_modules/swiper/modules/index.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white/90 p-5 sm:p-20" }, _attrs))}><div class="title"><p class="text-4xl font-bold">Lorem Ipum</p></div><div class="py-5">`);
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class=""><div class="flextravel-card overflow-hidden rounded-3xl bg-cover"><div class="bg-white/80 p-5 sm:p-20"><div class="title flex justify-center align-middle pb-20" data-swiper-parallax="-300"><p class="pr-2 text-6xl font-bold">Welcome to</p><p class="text-6xl font-bold text-green-400">${ssrInterpolate(unref(post).title.slice(0, 15))}</p></div><div class="h-80 w-auto bg-cover bg-center bg-no-repeat rounded-3xl" style="${ssrRenderStyle({ backgroundImage: `url(../img/${unref(post).id}.jpg)` })}"></div><div class="subtitle pt-20"><p class="text-2xl font-light">${ssrInterpolate(unref(post).body.slice(0, 40))}</p></div><div class="text pt-10"><p class="text-lg">${ssrInterpolate(unref(post).body)} ${ssrInterpolate(unref(post).body)}</p></div></div></div><div class="flextravel-card border border-colors-black border-2 flex overflow-hidden rounded-3xl bg-cover"><div class="bg-white/80 p-5 sm:py-20 sm:px-10"><div class="title"><p class="text-4xl font-bold">${ssrInterpolate(unref(post).title)}</p></div><div class="subtitle pt-10"><p class="text-2xl font-light">${ssrInterpolate(unref(post).body.slice(0, 40))}</p></div><div class="text pt-10"><p class="text-lg">${ssrInterpolate(unref(post).body)} ${ssrInterpolate(unref(post).body)}</p></div></div><div class="bg-white/80 p-5 sm:p-20"><div class="title"><p class="text-4xl font-bold">${ssrInterpolate(unref(post).title)}</p></div><div class="subtitle pt-10"><p class="text-2xl font-light">${ssrInterpolate(unref(post).body.slice(0, 40))}</p></div><div class="text pt-10"><p class="text-lg">${ssrInterpolate(unref(post).body)} ${ssrInterpolate(unref(post).body)}</p></div></div></div><div class="travel-card mt-10 overflow-hidden rounded-3xl"><div class="bg-white/80 p-5 sm:p-20">`);
      ...
      _push(`</div></div><div class="grid grid-cols-3 gap-5"><div class="flextravel-card flex overflow-hidden rounded-3xl bg-cover">`);
      _push(ssrRenderComponent(_component_RateComponent, null, null, _parent));
      _push(`</div><div class="flextravel-card flex overflow-hidden rounded-3xl bg-cover">`);
      _push(ssrRenderComponent(_component_RateComponent, null, null, _parent));
      _push(`</div><div class="flextravel-card flex overflow-hidden rounded-3xl bg-cover">`);
      _push(ssrRenderComponent(_component_RateComponent, null, null, _parent));
...
//# sourceMappingURL=_id_-nmxHtFEY.mjs.map
