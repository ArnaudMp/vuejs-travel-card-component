...
import { defineComponent, ref, computed, h, mergeProps, useSSRContext, withCtx, createVNode, createTextVNode, toDisplayString } from 'file:///Users/arnaudsween/Documents/GC-Tech/vuejs-travel-card-component/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-t from-gray-100/40 to-gray-100/40" }, _attrs))}><div class="container mx-auto max-h-screen max-w-screen-xl px-8">`);
      ...
      _push(`<div class="container mx-auto max-w-screen-xl px-8"><div class="pb-24 pt-12">`);
...
//# sourceMappingURL=default-BVi0zX9s.mjs.map
