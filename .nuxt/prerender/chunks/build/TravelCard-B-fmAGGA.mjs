...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))}><div class="transition-colors ease-in-out duration-300 bg-black/40 hover:bg-black/20 p-5 sm:p-20 text-left"><div class="title" data-swiper-parallax="-300"><p class="text-4xl font-bold">${ssrInterpolate($setup.post.title.slice(0, 25))}</p></div><div class="subtitle pt-10" data-swiper-parallax="-200"><p class="text-2xl font-light">${ssrInterpolate($setup.post.body.slice(0, 40))}</p></div><div class="text pt-10" data-swiper-parallax="-100"><p class="text-lg">${ssrInterpolate($setup.post.body)} ${ssrInterpolate($setup.post.body)}</p></div><div class="button pl-1 pt-10">`);
...
//# sourceMappingURL=TravelCard-B-fmAGGA.mjs.map
