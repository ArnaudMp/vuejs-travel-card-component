import { withAsyncContext, mergeProps, unref, useSSRContext } from 'file:///Users/arnaudsween/Documents/GC-Tech/vuejs-travel-card-component/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent } from 'file:///Users/arnaudsween/Documents/GC-Tech/vuejs-travel-card-component/node_modules/vue/server-renderer/index.mjs';
import { T as TravelCard } from './TravelCard-B-fmAGGA.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "destinations" }, _attrs))}><main class="mt-4 text-white [&amp;&gt;*]:mb-4 grid grid-cols-1 md:grid-cols-2 gap-4"><!--[-->`);
      ssrRenderList(unref(posts), (post) => {
        _push(`<div class="card max-h-none rounded-2xl">`);
...
//# sourceMappingURL=index-BrSxNdY4.mjs.map
