            ...
            createVNode("div", { class: "bg-white/50 p-5 text-left text-black transition-colors duration-500 ease-in-out hover:bg-black/30 hover:text-white sm:p-20" }, [
              createVNode("div", { class: "grid grid-cols-2 justify-between" }, [
                createVNode("div", {
                  ...
                  createVNode("p", { class: "text-xl sm:text-4xl font-bold" }, toDisplayString($setup.post.title.charAt(0).toUpperCase() + $setup.post.title.slice(1, 20)), 1)
                ]),
              ...
              createVNode("div", {
                ...
                createVNode("p", { class: "text-md sm:text-2xl font-light" }, toDisplayString($setup.post.body.slice(0, 25)), 1)
              ]),
              createVNode("div", {
                class: "text pt-4 sm:pt-10",
                "data-swiper-parallax": "-100"
              }, [
                createVNode("p", { class: "text-xs sm:text-lg" }, toDisplayString($setup.post.body.slice(0, 100)) + " " + toDisplayString($setup.post.body.slice(0, 100)), 1)
              ]),
...
//# sourceMappingURL=TravelCard-FiZ2sLyW.mjs.map
