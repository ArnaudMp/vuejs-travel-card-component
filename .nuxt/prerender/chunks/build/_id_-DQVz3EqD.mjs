...
import { ssrRenderAttrs, ssrRenderStyle, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass } from 'file:///Users/arnaudsween/Documents/GC-Tech/vuejs-travel-card-component/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="absolute left-0 -z-10 -mt-40 h-screen w-screen bg-cover" style="${ssrRenderStyle({ backgroundImage: `url(../img/${unref(post).id}.jpg)` })}"></div><div class="z-10"><div class="flextravel-card overflow-hidden rounded-3xl bg-cover"><div class="bg-white/80 p-5 sm:p-20"><div class="title flex align-middle justify-center" data-swiper-parallax="-300"><p class="text-4xl font-bold pr-2">Welcome to </p><p class="text-4xl font-bold text-green-400">${ssrInterpolate(unref(post).title.slice(0, 15))}</p></div><div class="subtitle pt-10"><p class="text-2xl font-light">${ssrInterpolate(unref(post).body.slice(0, 40))}</p></div><div class="text pt-10"><p class="text-lg">${ssrInterpolate(unref(post).body)} ${ssrInterpolate(unref(post).body)}</p></div></div></div><div class="flextravel-card mt-10 flex overflow-hidden rounded-3xl bg-cover"><div class="bg-white/80 p-5 sm:p-20"><div class="title"><p class="text-4xl font-bold">${ssrInterpolate(unref(post).title)}</p></div><div class="subtitle pt-10"><p class="text-2xl font-light">${ssrInterpolate(unref(post).body.slice(0, 40))}</p></div><div class="text pt-10"><p class="text-lg">${ssrInterpolate(unref(post).body)} ${ssrInterpolate(unref(post).body)}</p></div></div><div class="bg-white/80 p-5 sm:p-20"><div class="title"><p class="text-4xl font-bold">${ssrInterpolate(unref(post).title)}</p></div><div class="subtitle pt-10"><p class="text-2xl font-light">${ssrInterpolate(unref(post).body.slice(0, 40))}</p></div><div class="text pt-10"><p class="text-lg">${ssrInterpolate(unref(post).body)} ${ssrInterpolate(unref(post).body)}</p></div></div></div><div class="travel-card mt-10 overflow-hidden rounded-3xl"><div class="bg-white/80 p-5 sm:p-20">`);
      ...
      _push(`</div></div><div class="grid grid-cols-3 gap-5 mt-10"><div class="flextravel-card mt-10 flex overflow-hidden rounded-3xl bg-cover">`);
...
//# sourceMappingURL=_id_-DQVz3EqD.mjs.map
