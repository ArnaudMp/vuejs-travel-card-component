...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///Users/arnaudsween/Documents/GC-Tech/vuejs-travel-card-component/node_modules/ufo/dist/index.mjs';
...
storage.mount('data', fsDriver({"driver":"fsLite","base":"/Users/arnaudsween/Documents/GC-Tech/vuejs-travel-card-component/.data/kv"}));
...
const _lazy_4GmcnZ = () => import('./_/renderer.mjs').then(function (n) { return n.r; });
