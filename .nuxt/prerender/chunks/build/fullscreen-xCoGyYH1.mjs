...
import { ssrRenderAttrs, ssrRenderSlot } from 'file:///Users/arnaudmichel/Documents/GC-Tech/vuejs-travel-card-component/node_modules/vue/server-renderer/index.mjs';
import { s as useRouter, k as useLocaleHead } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[url('assets/img/background.jpg')] bg-cover text-black" }, _attrs))}><div class="rounded-2xl bg-white p-6 shadow-xl dark:bg-slate-800"><button class="m-2 rounded-lg border border-slate-200 bg-gray-50 p-4 py-3 text-gray-700 hover:cursor-pointer hover:border-slate-200 hover:bg-slate-200 dark:border-gray-700 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700"> \u2190 </button>`);
...
//# sourceMappingURL=fullscreen-xCoGyYH1.mjs.map
