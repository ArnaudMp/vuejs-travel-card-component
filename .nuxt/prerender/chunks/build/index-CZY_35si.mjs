...
import { T as TravelCard } from './TravelCard-DAqqoGQO.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "destinations" }, _attrs))}><main class="text-white px-2 sm:px-10 grid gap-4 grid-cols-1 sm:grid-cols-2"><!--[-->`);
...
//# sourceMappingURL=index-CZY_35si.mjs.map
